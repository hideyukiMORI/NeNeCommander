...
4. Actual-window conflict keyboard interaction is also unexecuted release environmental proof. The current tree has no test-owned conflict fixture, UIA exposes no invokable command route, and synthetic keyboard input is prohibited. The focused Presentation route test is not a claim of real WinUI interaction.
