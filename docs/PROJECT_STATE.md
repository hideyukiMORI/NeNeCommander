...
- In-progress vertical slice: [Issue #49](https://github.com/hideyukiMORI/NeNeCommander/issues/49) in Draft PR #53 after integration of the latest `main`: focused tests, pre-integration deep review, and normal-desktop false/true runtime verification pass; final-head CI is still owed
...
- Verified implementation baseline: `dd6439e093573cfc618468ebd1823a6f8177069a`
...
- Next vertical slice: mark Draft PR #53 Ready and obtain fresh canonical CI evidence for the final hidden-item-visibility candidate, then merge it. It has absorbed the latest `main`; focused tests, pre-integration deep review, and normal-desktop false/true runtime verification pass. The hidden-visibility keystroke, which needs a keyboard-model revision, and the collision resolver (FS-007) follow.
