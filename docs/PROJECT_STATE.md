...
- Active atomic-move work: [Issue #75](https://github.com/hideyukiMORI/NeNeCommander/issues/75); use mounted-volume identity and complete capability preflight before a same-volume Windows local atomic move.
- Policy foundation authorized by hide on: `2026-09-02`

## Current checkpoint

- Verified implementation baseline: `ebce917e68bf342315399245a05ab8a8053393e0`
...
- Next focused work: complete [Issue #75](https://github.com/hideyukiMORI/NeNeCommander/issues/75), then continue Win32 file-identifier identity hardening and WSL provider work. Issues #72–#74 retain only their documented product-decision dependencies.
