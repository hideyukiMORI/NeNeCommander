...
- In-progress lifecycle work: [Issue #59](https://github.com/hideyukiMORI/NeNeCommander/issues/59) on branch `fix/59-task-lifecycle-ownership`; ADR-0030 owns launch and pane work through one lifecycle mechanism
- Policy foundation authorized by hide on: `2026-09-02`

## Current checkpoint

- Verified implementation baseline: `1b508039efc85fa2dfedd3c78697b6f1bd046c62`
