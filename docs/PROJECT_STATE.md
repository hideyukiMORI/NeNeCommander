...
- In-progress I/O responsiveness work: [Issue #56](https://github.com/hideyukiMORI/NeNeCommander/issues/56) on branch `perf/56-windows-io-execution-boundary`; ADR-0027 schedules synchronous Windows local provider work through one shared boundary
