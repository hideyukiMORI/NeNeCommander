...
- Next vertical slice: the design pass — a design brief under `docs/design/`, a Claude Design canvas hide adjusts and approves, then token-only integration under `docs/DESIGN_HANDOFF.md` (see the handoff). Feature work resumes with the collision resolver (FS-007) afterwards.
