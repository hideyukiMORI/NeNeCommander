...
- Next product vertical slice: `F6` moving the active pane's item to the passive pane through `FileOperationGateway`; not started, open a focused Issue and branch before implementation.
