...
- Current product vertical slice: typed progress of a running operation reported through the session and rendered beside the status ([Issue #31](https://github.com/hideyukiMORI/NeNeCommander/issues/31), ADR-0019).
