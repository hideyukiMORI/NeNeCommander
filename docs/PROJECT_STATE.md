...
- Active test-platform work: [Issue #68](https://github.com/hideyukiMORI/NeNeCommander/issues/68); update the single `MSTest.Sdk` pin from 4.3.3 to 4.4.0 without changing the Microsoft.Testing.Platform runner mechanism.
...
- Next focused work: complete [Issue #68](https://github.com/hideyukiMORI/NeNeCommander/issues/68) by proving the 4.4.0 runner's discovery, filtering, coverage, and locked dependency graph, then integrate through the canonical Ready CI gate.
