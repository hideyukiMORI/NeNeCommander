...
- Active WSL discovery work: [Issue #79](https://github.com/hideyukiMORI/NeNeCommander/issues/79); implement the ADR-0004 catalog through one bounded fixed process boundary without adding a shell mutation route.
- Policy foundation authorized by hide on: `2026-09-02`

## Current checkpoint

- Verified implementation baseline: `b29419bb8efadcfe199e436879e2e3118eb73ca6`
...
- Next focused work: complete [Issue #79](https://github.com/hideyukiMORI/NeNeCommander/issues/79), then implement WSL directory access and file operations as separate provider-owned Issues. Issues #72–#74 retain only their documented product-decision dependencies.
