...
- Next focused work: complete [Issue #85](https://github.com/hideyukiMORI/NeNeCommander/issues/85), then implement cross-provider Windows local/WSL transfer as a separate provider-routing Issue. Issues #72–#74 retain only their documented product-decision dependencies.
