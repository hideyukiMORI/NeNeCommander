...
- In-progress vertical slice: [Issue #49](https://github.com/hideyukiMORI/NeNeCommander/issues/49) in Draft PR #53 after integration of the latest `main`: focused tests and the pre-integration deep review pass; interactive-desktop runtime verification and final-head CI are still owed
