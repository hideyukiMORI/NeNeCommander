...
- Active security work: [Issue #2](https://github.com/hideyukiMORI/NeNeCommander/issues/2); ADR-0031 excludes only generated `obj` trees from CodeQL while owned findings remain mandatory
- Policy foundation authorized by hide on: `2026-09-02`

## Current checkpoint

- Verified implementation baseline: `ca4fd7be3c2f12532e392c88c44bcd81d73a7c7e`
...
- Next focused work: resolve the open security follow-up in [Issue #2](https://github.com/hideyukiMORI/NeNeCommander/issues/2) by reading back current CodeQL alerts and separating generated-output noise from owned-source findings without weakening the configured query suite.
