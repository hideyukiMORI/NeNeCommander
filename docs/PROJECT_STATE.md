...
- Active WSL same-distribution mutation work: [Issue #83](https://github.com/hideyukiMORI/NeNeCommander/issues/83); route directory creation, same-parent rename, and confirmed permanent deletion through the canonical `FileOperationGateway` without enabling transfer or collision replacement.
- Policy foundation authorized by hide on: `2026-09-02`

## Current checkpoint

- Verified implementation baseline: `1b5142825b877e47e675f099b38c33a914583b0f`
...
- Next focused work: complete [Issue #83](https://github.com/hideyukiMORI/NeNeCommander/issues/83), then implement WSL transfer semantics as a separate provider-owned Issue. Issues #72–#74 retain only their documented product-decision dependencies.
