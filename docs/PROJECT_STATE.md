...
- In-progress copy-safety work: [Issue #58](https://github.com/hideyukiMORI/NeNeCommander/issues/58) on branch `fix/58-partial-copy-effect`; ADR-0029 reports a top-level target left by a failed copy
