...
- Active Windows identity hardening: [Issue #77](https://github.com/hideyukiMORI/NeNeCommander/issues/77); preserve the single `WindowsLocalEntryIdentity` revalidation route while adding reparse-safe Win32 volume/file identifiers.
- Policy foundation authorized by hide on: `2026-09-02`

## Current checkpoint

- Verified implementation baseline: `cda8f7dbdbce83217854a764ccafb067eef08760`
...
- Next focused work: complete [Issue #77](https://github.com/hideyukiMORI/NeNeCommander/issues/77), then continue WSL provider work. Issues #72–#74 retain only their documented product-decision dependencies.
