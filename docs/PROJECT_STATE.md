...
- Issue [#103](https://github.com/hideyukiMORI/NeNeCommander/issues/103) refined the sole path parser contract through ADR-0042: raw input and successful canonical text are each limited to 32767 UTF-16 code units. Exact head `8fd0da9a` passed deep run `34041924385` and canonical Ready run `34043839856` before merge `0dab3f67`; Issue #99 does not carry a duplicate bookmark-local length rule.
